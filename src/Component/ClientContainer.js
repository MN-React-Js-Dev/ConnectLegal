        ...
        <div className="client-says">
          <div className="clients-header">
            <div className="client-test">
              ...
              <h2 className="what-client-says">
                what <br /> client says
              </h2>
              <div className="discription">
                <p>
                  "We quickly had to get legal counsel, and luckily for us, we
                  found the Connect Legal platform. The rapport and guidance was
                  outstanding at all times, prompt, timely, and open for calls
                  and quick updates".
                </p>
                <a className="seeMore">
                  See More{" "}
